...
export const micky = pgSchema("micky");

export const notificationTypeEnum = micky.enum("notification_type", [
  "todoist_video_live",
  "discord_video_live",
  "discord_flagged_comment",
]);

export const videos = micky.table(
  "videos",
  {
...
export const comments = micky.table(
  "comments",
  {
...
export const sponsors = micky.table(
  "sponsors",
  {
...
export const sponsorToVideos = micky.table(
  "sponsor_to_videos",
  {
...
export const notifications = micky.table(
  "notifications",
  {
...
export const crawlerState = micky.table("crawler_state", {
