...
export const davis = pgSchema("davis");

export const notificationTypeEnum = davis.enum("notification_type", [
  "todoist_video_live",
  "discord_video_live",
  "discord_flagged_comment",
]);

export const videos = davis.table(
  "videos",
  {
...
export const comments = davis.table(
  "comments",
  {
...
export const sponsors = davis.table(
  "sponsors",
  {
...
export const sponsorToVideos = davis.table(
  "sponsor_to_videos",
  {
...
export const notifications = davis.table(
  "notifications",
  {
...
export const crawlerState = davis.table("crawler_state", {
