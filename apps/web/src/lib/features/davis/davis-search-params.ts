import { normalizePage, normalizeQuery } from '@/services/davis/davis-utils'
...
export const parseDavisListSearch = (value: unknown) => {
...
export const parseDavisVideoSearch = (value: unknown) => {
  const search = toObject(value)
...
export const parseDavisSponsorSearch = (value: unknown) => {
  const search = toObject(value)
