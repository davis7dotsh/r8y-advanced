...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async GetSponsor(
        sponsorPrompt: string,videoDescription: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.SponsorInfo> {
          try {
          ...
          const __stream__ = this.stream.GetSponsor(
          sponsorPrompt,videoDescription,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "GetSponsor",
            {
            "sponsorPrompt": sponsorPrompt,"videoDescription": videoDescription
            },
            ...
            return __raw__.parsed(false) as types.SponsorInfo
            } catch (error) {
        ...
        async ParseComment(
        videoTitle: string,videoDescription: string,commentAuthor: string,commentText: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.CommentParse> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.ParseComment(
          videoTitle,videoDescription,commentAuthor,commentText,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "ParseComment",
            {
            "videoTitle": videoTitle,"videoDescription": videoDescription,"commentAuthor": commentAuthor,"commentText": commentText
            },
            this.ctxManager.cloneContext(),
            __options__.tb?.__tb(),
            __clientRegistry__,
            ...
            return __raw__.parsed(false) as types.CommentParse
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            sponsorPrompt: string,videoDescription: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.SponsorInfo, types.SponsorInfo>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for GetSponsor", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.SponsorInfo, types.SponsorInfo>(
                  __raw__,
                  (a): partial_types.SponsorInfo => a,
                  (a): types.SponsorInfo => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            videoTitle: string,videoDescription: string,commentAuthor: string,commentText: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.CommentParse, types.CommentParse>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for ParseComment", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.CommentParse, types.CommentParse>(
                  __raw__,
                  (a): partial_types.CommentParse => a,
                  (a): types.CommentParse => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
