...
<main class="min-h-screen bg-neutral-50 px-4 py-12 dark:bg-neutral-950 sm:px-6">
  <div class="mx-auto max-w-xl">
    {#if videoQuery.error}
      <div
        class="rounded-xl border border-red-200 bg-red-50 p-5 text-sm text-red-700 dark:border-red-800 dark:bg-red-950 dark:text-red-300"
      >
    ...
    {:else if !videoQuery.ready}
      <div class="space-y-4">
        <div
          class="aspect-video w-full animate-pulse rounded-xl bg-neutral-200 dark:bg-neutral-800"
        ></div>
        <div
          class="h-5 w-3/4 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800"
        ></div>
        <div
          class="h-4 w-1/2 animate-pulse rounded bg-neutral-100 dark:bg-neutral-700"
        ></div>
      </div>
    ...
    {:else}
      ...
      <article class="space-y-5">
        ...
        <div class="space-y-1">
          ...
          <h1
            class="text-xl font-bold leading-snug tracking-tight text-neutral-900 dark:text-neutral-100"
          >
            {video.title}
          </h1>
        ...
        <div class="space-y-3">
          <div class="flex items-baseline gap-2">
            <span
              class="text-2xl font-bold tabular-nums text-neutral-900 dark:text-neutral-100"
            >
          ...
          >
            <div class="flex items-center gap-3">
              <div
                class="flex size-9 items-center justify-center rounded-lg bg-red-100 dark:bg-red-950"
              >
                <svg
              ...
              <div>
                ...
                <div
                  class="flex flex-wrap items-baseline gap-x-4 gap-y-0.5 text-sm"
                >
                  <span>
                    <span
                      class="font-semibold text-neutral-900 dark:text-neutral-100"
                      >{formatMetric(video.viewCount)}</span
                    >
                  ...
                  <span>
                    <span
                      class="font-semibold text-neutral-900 dark:text-neutral-100"
                      >{formatMetric(video.likeCount)}</span
                    >
                  ...
                  <span>
                    <span
                      class="font-semibold text-neutral-900 dark:text-neutral-100"
                      >{formatMetric(video.commentCount)}</span
                    >
          ...
          {#if video.xPost}
            ...
            >
              <div class="flex items-center gap-3">
                <div
                  class="flex size-9 items-center justify-center rounded-lg bg-neutral-100 dark:bg-neutral-800"
                >
                  <svg
                    class="size-4 text-neutral-800 dark:text-neutral-200"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
                    <path
                ...
                <div>
                  ...
                  >
                    <span>
                      <span
                        class="font-semibold text-neutral-900 dark:text-neutral-100"
                        >{formatMetric(video.xPost.views)}</span
                      >
                      <span class="ml-1 text-neutral-400">views</span>
                    </span>
                    <span>
                      <span
                        class="font-semibold text-neutral-900 dark:text-neutral-100"
                        >{formatMetric(video.xPost.likes)}</span
                      >
                      <span class="ml-1 text-neutral-400">likes</span>
                    </span>
                    <span>
                      <span
                        class="font-semibold text-neutral-900 dark:text-neutral-100"
                        >{formatMetric(video.xPost.reposts)}</span
                      >
                    ...
                    <span>
                      <span
                        class="font-semibold text-neutral-900 dark:text-neutral-100"
                        >{formatMetric(video.xPost.comments)}</span
                      >
